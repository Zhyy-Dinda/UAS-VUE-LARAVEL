              ...
              <div class="card-body">
                ...
                <div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
                  <div class="px-2 pb-2 pb-md-0 text-center">
                    ...
                    <h6 class="fw-bold mt-3 mb-0">Data Users</h6>
                  </div>
                  <div class="px-2 pb-2 pb-md-0 text-center">
                    <div id="circles-2"></div>
                    <h6 class="fw-bold mt-3 mb-0">Ruang</h6>
                  </div>
                  <div class="px-2 pb-2 pb-md-0 text-center">
                  ...
                  <div class="px-2 pb-2 pb-md-0 text-center">
                    ...
                    <h6 class="fw-bold mt-3 mb-0">Inventaris</h6>
                  </div>
                  <div class="px-2 pb-2 pb-md-0 text-center">
                  ...
                  <div class="px-2 pb-2 pb-md-0 text-center">
                    <div id="detail"></div>
                    <h6 class="fw-bold mt-3 mb-0">Detail</h6>
                  </div>
                </div>
              </div>
            </div>
